...
const CUES: Array<[RegExp, number]> = [
  ...
  [/\b(unfortunately|sadly|alas|apparently|supposedly|somehow)\b/i, 2],
  ...
  [/\b(wait|hold on|actually|turns out|it seems|seems like|looks like)\b/i, 2],
  [SELF_RE, 2],
  [USER_RE, 2],
